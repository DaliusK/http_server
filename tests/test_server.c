...
static char * test_process_request_send_file()
{
    ...
    mu_assert("Error, process_request should've returned file", is_in_file(FILENAME, "send file test") == 1);
...
static char * test_process_request_list_dir()
{
    ...
    mu_assert("Error, should've printed directory listing", is_in_file(FILENAME, "Index of /") == 1);
...
static char * test_process_request_no_dir_slash()
{
    ...
    mu_assert("Error, should've printed directory listing", is_in_file(FILENAME, "302") == 1);
...
static char * test_process_request_index_found()
{
    ...
    mu_assert("Error, should've printed directory listing", is_in_file(FILENAME, "test index file") == 1);
